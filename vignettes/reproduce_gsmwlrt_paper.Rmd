...
```{r}
#############################
### control 8m; recruitment 1

c8_r1_null_mw <- three_stage_sim(n_sims = 10, design = d_8m_control_4m_delay,    model = model_8m_control_null, recruitment = recruitment_1)
c8_r1_null_lr <- three_stage_sim(n_sims = 10, design = d_8m_control_4m_delay_lr, model = model_8m_control_null, recruitment = recruitment_1)

c8_r1_d0_mw <- three_stage_sim(n_sims = 10, design = d_8m_control_4m_delay,    model = model_8m_control_0m_delay, recruitment = recruitment_1)
c8_r1_d0_lr <- three_stage_sim(n_sims = 10, design = d_8m_control_4m_delay_lr, model = model_8m_control_0m_delay, recruitment = recruitment_1)

c8_r1_d4_mw <- three_stage_sim(n_sims = 10, design = d_8m_control_4m_delay,    model = model_8m_control_4m_delay, recruitment = recruitment_1)
c8_r1_d4_lr <- three_stage_sim(n_sims = 10, design = d_8m_control_4m_delay_lr, model = model_8m_control_4m_delay, recruitment = recruitment_1)

c8_r1_d8_mw <- three_stage_sim(n_sims = 10, design = d_8m_control_4m_delay,    model = model_8m_control_8m_delay, recruitment = recruitment_1)
c8_r1_d8_lr <- three_stage_sim(n_sims = 10, design = d_8m_control_4m_delay_lr, model = model_8m_control_8m_delay, recruitment = recruitment_1)


#############################
### control 10m; recruitment 1

c10_r1_null_mw <- three_stage_sim(n_sims = 10, design = d_8m_control_4m_delay,    model = model_8m_control_null, recruitment = recruitment_1)
c8_r1_null_lr <- three_stage_sim(n_sims = 10, design = d_8m_control_4m_delay_lr, model = model_8m_control_null, recruitment = recruitment_1)
